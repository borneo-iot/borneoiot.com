...
**We are building an open, modular, and affordable platform for smart aquarium devices.**
...
Hi, I'm Wei Li, the founder of this project and a software engineer from Yunnan, China. For the past 4+ years I have single-handedly designed the hardware (PCB), written the firmware, developed the cross-platform Flutter app, and built this entire website. Every line of code, every solder joint, and every pixel is the result of one person's passion for affordable, open-source aquarium technology.
